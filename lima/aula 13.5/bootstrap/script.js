...
objs.forEach( a => {
  ...
  model.setAttribute("id", "model" + a.id);
  model.querySelector(".card-title").innerHTML = a.tipo;
  model.querySelector(".card-text").innerHTML = a.produto;
  model.querySelector(".img").src = a.img;
  model.querySelector(".card-footer").innerHTML = `R$ ${parseFloat(a.preco).toFixed(2)}`;
